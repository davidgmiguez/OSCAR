...
function analyzeImage(path::String, rootpath::String, zparams::Union{Vector{Int},Nothing}=nothing) 
...
function startOSCAR()
    ...
    set_gtk_property!(checkbox, :active, true);
